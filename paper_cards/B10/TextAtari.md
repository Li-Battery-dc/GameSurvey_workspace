...
- Best use in Section 1 (taxonomy and evolutionary levels): Useful in the lineage from Atari RL toward language-agent control benchmarks. Clarifies the difference between text-rendered and raw-visual game environments.
