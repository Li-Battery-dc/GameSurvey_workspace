...
### 3.2 World structure
- World type(s): puzzle / adventure / sandbox / other
- Real game / simulated game / designed task-game hybrid: curated suite of browser games under a shared sandbox runtime
