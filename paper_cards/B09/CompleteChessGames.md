...
- Construction note: real board game represented through textual FEN states and next-move prediction
...
- Best comparison targets inside our corpus: MixingExpertKnowledge, PokerBench, GTOWizardBenchmark, PokeChamp
