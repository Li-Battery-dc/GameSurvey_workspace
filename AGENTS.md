...
If the task touches paper-card creation or review, also open:
...
3. Stage 3: review and promote evidence. Run the eval gate before section drafting. Only strong or usable cards that pass `evals/quality_rubric.md` and `evals/batch_review_checklist.md` should be promoted to `card-reviewed`.
