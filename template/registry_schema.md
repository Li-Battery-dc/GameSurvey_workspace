...
| :--- | :--- | :--- |
| `paper_id` | Stable paper slug used across the repo | `balrog` |
...
| `paper_card_path` | Relative path to the paper card | `paper_cards/{paper_id}.md` |
...
- `paper_id`: keep it stable and lowercase.
