...
| 7 | LVLMGamePlayers | Are Large Vision-Language Models Good Game Players? | representative | 1,2,3,4 | Bridge paper from board-game-family diagnostics to visual agency; strongest for fine-grained ability decomposition and component-vs-E2E failure analysis in screenshot-grounded play. |
