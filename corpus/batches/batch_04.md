...
| 3 | StarBench | StarBench: A Turn-Based RPG Benchmark for Agentic Multimodal Decision-Making and Information Seeking | representative | 2,3,4 | Strong GUI benchmark for pixel-to-action control and ask-or-act information seeking. |
...
| 5 | VideoGameBench | VideoGameBench: Can VLM Complete Popular Video Games? | representative | 2,3,4 | Raw-visual real-time benchmark is a strong ecological comparison target for BALROG. |
| 6 | VMage | V-MAGE: A Game Evaluation Framework for Assessing Visual-Centric Agentic Foundation Models | representative | 2,3,4 | Visual-centric agent benchmark with Elo-style evaluation across dynamic game interactions. |
| 7 | LVLMGamePlayers | Are Large Vision-Language Models Good Game Players? | contrast | 1,2,3,4 | Early visual-game comparison set useful as a historical baseline for later ecological work. |
