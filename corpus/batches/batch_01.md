...
- Compare how early multi-game benchmarks, single-game probes, and stable anchor-based evaluation support Sections 0, 1, 2, 3, and 5.

## Reading Order

| Order | paper_id | Title | Priority | Recommended depth | Outline anchors | Why this paper is in the batch |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | SmartPlay | SmartPlay | P0 | deep | 0,1,2,3 | Foundational multi-game benchmark for rule following and controlled agent evaluation. |
