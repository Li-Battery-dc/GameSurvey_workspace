...
| 4 | SudokuBench | Sudoku-Bench: Evaluating creative reasoning with Sudoku variants | contrast | 1,2,4 | Tool-free text benchmark for creative Sudoku break-ins; best used as a symbolic reasoning contrast and for separating intrinsic reasoning from optional tool-use tracks. |
