...
| 6 | PokeAgentChallenge | The PokeAgent Challenge: Competitive and Long-Context Learning at Scale | contrast | 2,3,4 | Competition-scale benchmark for long-context opponent modeling in Pokemon battles. [uncertain: historical-placement] |
| 7 | ComplexCardGames | Can Large Language Models Master Complex Card Games? | contrast | 2,3,4 | Training-heavy card-game suite for transfer, retention, and teacher-data evaluation; useful contrast rather than ecological benchmark. |
